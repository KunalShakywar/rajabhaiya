...
export default function AddCustomerModal({ open, onClose, onSubmit }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-lg rounded-xl bg-white dark:bg-gray-900 p-6 shadow-xl border  border-white dark:border-slate-700">
                <div className="mb-4 flex items-center justify-between">
                    <h2 className="text-xl font-bold">Add Customer</h2>
                    <button onClick={onClose} className="text-2xl leading-none text-red-500 hover:text-gray-400 cursor-pointer">
                        ×
                    </button>
                </div>
